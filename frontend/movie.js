...
div_new.innerHTML = `
    <div class="row">
        <div class="column">
            ...
            <input type="text" id="newReview" placeholder="Enter your review" value="">
            </p>
            <p><strong>User:</strong>
            <input type="text" id="newUser" placeholder="Enter your name" value="">
            </p>
            <p><a href="#" onclick="saveReview('newReview', 'newUser')">💾</a></p>
            </div>
        </div>
    </div>
`;
...
function editReview(id, review, user) {
    ...
    element.innerHTML = `
        ...
        <p>
            ...
            <a href="#" onclick="cancelEdit('${id}', '${review}', '${user}')">❌</a>
        </p>
    `;
